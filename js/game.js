...
function startLevel(){
	...
	gui = new Container();
	scoreText = new Text("SCORE: ", "17px impact", "#AFF");
	scoreText.x = 10;
	scoreText.y = 5;
	scoreBack = new Shape();
	scoreBack.graphics.beginFill('rgba(50,180,250,0.35)').drawRoundRectComplex(0,0,150,30,0,0,30,0)//.rect(0,0,150,30);
